      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8 mb-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <Link to="/Sellspage" className="w-full md:w-auto">
            <button className="group w-full bg-gradient-to-r from-custom-blue to-custom-brown text-white px-6 py-3 rounded-xl text-base font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2">
        ...
        <div className="p-6">
          {recentActivity.length > 0 ? (
              ...
              {recentActivity.slice(0, showAllActivity ? 4 : 2).map((item) => (
                ...
                >
                  <div className="flex items-center gap-4 flex-1">
                    <div className="w-10 h-10 bg-gradient-to-br from-custom-blue/10 to-custom-i-berry/10 rounded-full flex items-center justify-center">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 text-sm mt-1">Start exploring notes to see your activity here</p>
            </div>
          )}
        </div>
      </div>
