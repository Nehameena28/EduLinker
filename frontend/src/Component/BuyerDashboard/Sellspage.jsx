   ...
   return (
     <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
       <div className="relative">
         <img src="/img/sellespage.png" className="w-full h-[60vh] sm:h-[70vh] lg:h-[80vh] object-cover" />
           ...
           <div className="mt-4 sm:mt-6 relative flex flex-col sm:flex-row items-center bg-white rounded-full shadow-lg border-2 border-gray-300 overflow-hidden w-full max-w-xs sm:max-w-2xl lg:max-w-3xl hover:shadow-xl hover:border-blue-500 focus-within:shadow-xl focus-within:border-blue-600 transition-all duration-300">
             <div className="flex items-center flex-grow w-full">
               ...
               <input
                 ...
                 className="flex-grow py-2 sm:py-3 pr-2 sm:pr-4 text-sm sm:text-base text-gray-700 placeholder-gray-500 focus:outline-none transition-all duration-200 bg-transparent"
               />
             </div>
             <button 
               onClick={handleSearch}
               className="bg-custom-blue text-white w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 font-medium hover:bg-opacity-90 transition-all duration-200 hover:scale-105 active:scale-95 flex items-center justify-center gap-2 text-sm sm:text-base"
             >
       ...
       <div className="px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
         <div className="max-w-6xl mx-auto">
           ...
           {isLoading ? (
             ...
             {[...Array(6)].map((_, index) => (
               <div
                 key={index}
                 className="animate-pulse bg-white shadow-lg rounded-xl sm:rounded-2xl p-4 sm:p-6 space-y-3 sm:space-y-4 border border-gray-100"
               >
             ...
             {filteredNotes.length > 0 ? (
               ...
               <div className="col-span-full text-center py-12 sm:py-16">
                 ...
                 <h3 className="text-lg sm:text-xl font-semibold text-gray-700 mb-2">No materials found</h3>
       ...
       {showPhoneModal && (
         <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
           <div className="bg-white/95 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-8 w-full max-w-sm sm:max-w-md shadow-2xl border border-custom-blue/20">
             <div className="text-center mb-6 sm:mb-8">
               <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-custom-blue/10 to-custom-blue/20 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg border border-custom-blue/30">
                 <svg className="w-8 h-8 sm:w-10 sm:h-10 text-custom-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                 </svg>
               </div>
               <h3 className="text-xl sm:text-2xl font-bold text-custom-blue mb-2 sm:mb-3">Complete Your Purchase</h3>
               <p className="text-gray-600 leading-relaxed text-sm sm:text-base">Please provide your phone number to proceed with secure payment</p>
             </div>
             
             <div className="mb-6 sm:mb-8">
               <label className="block text-xs sm:text-sm font-semibold text-custom-blue mb-2 sm:mb-3">
                 Phone Number
               </label>
               <input
                 type="tel"
                 ...
                 className="w-full px-4 sm:px-5 py-3 sm:py-4 border-2 border-custom-blue/30 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-custom-blue focus:border-custom-blue outline-none transition-all duration-300 text-sm sm:text-lg bg-white/80"
                 maxLength="10"
               />
             </div>
             ...
             <div className="flex gap-3 sm:gap-4">
               <button
                 ...
                 className="flex-1 px-4 sm:px-6 py-3 sm:py-4 bg-transparent border-2 border-custom-blue text-custom-blue rounded-lg sm:rounded-xl hover:bg-custom-blue hover:text-white transition-all duration-300 font-semibold text-sm sm:text-base"
               >
                 Cancel
               </button>
               <button
                 onClick={handlePhoneSubmit}
                 className="flex-1 px-4 sm:px-6 py-3 sm:py-4 bg-custom-blue border-2 border-custom-blue text-white rounded-lg sm:rounded-xl hover:bg-transparent hover:text-custom-blue transition-all duration-300 font-semibold text-sm sm:text-base"
               >
                 Continue
               </button>
             </div>
       ...
       {showLoginModal && (
         <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
           <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 w-full max-w-sm sm:max-w-md shadow-2xl border-l-4 border-custom-i-berry">
       ...
       {showPurchaseModal && selectedNoteForPurchase && (
         <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
           <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 w-full max-w-sm sm:max-w-md shadow-2xl border-l-4 border-blue-600">
             <div className="text-center">
               ...
               <h3 className="text-xl sm:text-2xl font-bold text-blue-600 mb-2 sm:mb-3">🔒 Purchase Required</h3>
               <p className="text-gray-600 mb-3 sm:mb-4 text-sm sm:text-base">You've reached the preview limit (4 pages)</p>
               <div className="bg-blue-50 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
                 <h4 className="font-semibold text-blue-800 mb-2 text-sm sm:text-base">{selectedNoteForPurchase.title}</h4>
                 <p className="text-xs sm:text-sm text-gray-700 mb-2">Category: {selectedNoteForPurchase.category}</p>
                 <p className="text-base sm:text-lg font-bold text-blue-600">Price: ₹{selectedNoteForPurchase.price}</p>
               </div>
               <p className="text-gray-500 text-xs sm:text-sm mb-4 sm:mb-6">Purchase this note to access the complete content</p>
               <div className="flex gap-2 sm:gap-3">
                 <button
                   onClick={() => {
                   ...
                   className="flex-1 px-3 sm:px-4 py-2 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-all duration-300 text-sm sm:text-base"
                 >
                   Cancel
                 </button>
                 <button
                   ...
                   className="flex-1 px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-300 font-semibold text-sm sm:text-base"
                 >
