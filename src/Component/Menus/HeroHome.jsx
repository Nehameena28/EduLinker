...
const HeroHome = () => {
  return (
    <>
      <b><h1 className="text-5xl text-center m-5">Features </h1></b>

      <div
        id="RemoveScrlbr"
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full mt-10 ml-0"
      >
        {/* First Div */}
        ...
        <div className="flex flex-col items-center p-4 rounded-xl hover:scale-105 transition-all duration-300 ease-in-out">
          <img
            ...
            className="mb-4 h-60 transition-transform duration-300 ease-in-out hover:scale-110"
          />
          <p className="text-lg font-semibold text-black hover:text-blue-500">The Best Platform for Both Buyer and Seller</p>
        </div>
      </div>
    </>
  );
